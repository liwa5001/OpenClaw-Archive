...
"""
创建 AMP HC 汇总 Sheet
汇总每个 site 2025 年 1 月和 2026 年 2 月的 Internal/External/Total 数据
将 Juarez 归为 Queretaro
"""
...
print(f"\n✅ 汇总 Sheet 已创建：{output_path}")
print(f"📄 Sheet 名称：HC_Summary")
print(f"📊 共 {len(summary_df)} 个 Site")

# 保存 CSV 备份
csv_path = '/Users/liwang/.openclaw/workspace/Temp/amp-hc-summary-comparison.csv'
