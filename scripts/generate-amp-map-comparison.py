...
"""
生成 AMP HC 数据对比地图
显示每个 site 2025 年 1 月和 2026 年 2 月的 Total 对比
不显示 Internal/External 细分
"""
...
LABEL_CONFIG = {
    # 亚洲
    "Suzhou": (70, 0, 95, 0),
    "Shanghai": (70, -55, 95, -80),
    "Chengdu": (-70, 0, -100, 0),
    "Bangalore": (50, 50, 75, 75),
    "Nagoya": (70, 65, 95, 90),
    
    # 欧洲
    "Garching": (0, 80, 0, 110),
    "Karlsbad": (-80, 60, -130, 85),
    "Szekesfehervar": (65, -60, 90, -85),
    
    # 美洲
    "Novi": (55, -55, 80, -80),
    "Queretaro": (55, 50, 80, 75),
}
...
# 保存文件
output_path = '/Users/liwang/.openclaw/workspace/Temp/world-map-amp-hc-comparison.png'
...
for site, data in sorted(hc_data.items()):
    if site in SITE_COORDS and (data['Total_2026'] > 0 or data['Total_2025'] > 0):
        ...
        change = data['Total_2026'] - data['Total_2025']
        print(f"  • {city_name}: {data['Total_2025']} → {data['Total_2026']} ({change:+d})")
