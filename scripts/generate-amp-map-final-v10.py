...
for site, data in hc_data.items():
    ...
    print(f"   标签位置：({label_x:.1f}, {label_y:.1f})")
...
# 保存文件
output_path = '/Users/liwang/.openclaw/workspace/Temp/world-map-amp-hc-final-v10.png'
