...
生成 AMP HC 数据对比地图 v2
- Novi 标签移到左边
- 不显示 Shanghai 和 Szekesfehervar
- 不显示 change abs，只显示 2025 → 2026
"""
...
for site, data in hc_data.items():
    ...
    # HC 数据对比标签 (只显示 2025 → 2026，不显示变化量)
...
# 保存文件
output_path = '/Users/liwang/.openclaw/workspace/Temp/world-map-amp-hc-comparison-v2.png'
