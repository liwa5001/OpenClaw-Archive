#!/usr/bin/env python3
"""
在标准 Mercator 投影地图上添加精确的城市标记 v3
修复标签截断和重叠问题
"""
...
for city, (lat, lon) in CITIES.items():
    ...
    # 标签偏移
    offset_x, offset_y = LABEL_OFFSETS.get(city, (25, -25))
...
# 保存文件
output_path = '/Users/liwang/.openclaw/workspace/world-map-standard-final-v3.png'
